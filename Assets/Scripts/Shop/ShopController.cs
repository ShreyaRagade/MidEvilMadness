...
//      //  private UseItemDictionary useItemDictionary;
...
//            useItemDictionary = FindFirstObjectByType<UseItemDictionary>();
...
//        {
//            if (UseInventoryController.Instance == null) return;
...
//                {
//                    UseItem originalItem = inventorySlot.item;
//                    //Add this back in
//                    CreateShopSlot(playerInventoryGrid, originalItem.generalItemID, false, 100, inventorySlot);
//                }
